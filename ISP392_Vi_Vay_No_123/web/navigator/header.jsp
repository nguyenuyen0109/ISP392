...
<head>
    ...
    <link rel="stylesheet" href="ISP392_Vi_Vay_No_123/assets//glightbox.min.css">
                            ...
                            <div class="col-8 text-center">
                                <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                    ...
                                    <li class="has-children">
                                        <a href="client/homepage.jsp">Pages</a>
                                        <ul class="dropdown">
                            ...
                            <div class="col-2 text-end">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li><a class="dropdown-item" href="/ISP392_Vi_Vay_No_123/changepassword.jsp">Change Password</a></li>
