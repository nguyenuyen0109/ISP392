...
public class DebtController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ResultSet rs = db.getData("select SUM(amount*0.01+debtdetails.amount*(1+(interestRate/100)*(due/12))) as totalDebt\n"
                + "from debtdetails where debtor_account_id = "+accountId+" and debtor_id= "+debtorId+";");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DebtDAO dao = new DebtDAO();
        DebtDetail debt = new DebtDetail(description, debtType, amount, image, debtorId,
                accountId, interest_rate, due);
